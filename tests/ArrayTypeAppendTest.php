...
class ArrayTypeAppendTest extends TestCase
{
    /**
     * @test
     * Verifies that a FooArrayType can be created and populated with valid objects via appending an array.
     * Ensures that the array properly stores and returns data as an array of associative arrays.
     */
    public function it_can_create_array_via_append()
    {
